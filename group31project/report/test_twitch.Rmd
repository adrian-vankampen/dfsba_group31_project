...
From this visualization, we can clearly see that the audiance is increasing over time, almost linearly. 
...
Average concurrent channels over the time
...
- Viewers per streamers only one decreasing
- Maybe saturated, easier to add streamers than viewers
- Linear until march 2020, then covid ++


Now some dynamic plot to disyplay our idea.
